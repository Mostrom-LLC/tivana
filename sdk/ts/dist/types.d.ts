...
export declare const ErrorCode: {
    ...
    readonly SessionExists: "session_exists";
    readonly InvalidSessionState: "invalid_session_state";
    readonly BrowserLaunchFailed: "browser_launch_failed";
    readonly BrowserCrashed: "browser_crashed";
    readonly BrowserDisconnected: "browser_disconnected";
    readonly NavigationFailed: "navigation_failed";
    readonly TargetNotFound: "target_not_found";
    readonly TargetAmbiguous: "target_ambiguous";
    readonly ActionFailed: "action_failed";
    readonly ActionTimeout: "action_timeout";
    readonly PerceptionFailed: "perception_failed";
    readonly ElementNotAccessible: "element_not_accessible";
    readonly StyleComputationFailed: "style_computation_failed";
...
/** Page event types */
export type PageEventType = "page.mutation" | "page.loaded" | "page.navigated" | "page.focus" | "page.scroll" | "page.resize";
...
export type PageEvent = {
    ...
    type: "page.loaded";
    data: PageLoadedEvent;
} | {
    type: "page.navigated";
    data: PageNavigatedEvent;
} | {
    type: "page.focus";
    data: PageFocusEvent;
} | {
    type: "page.scroll";
    data: PageScrollEvent;
} | {
    type: "page.resize";
    data: PageResizeEvent;
};
/** Event callback */
...
export type ClickTarget = string | {
    role: string;
    label: string;
};
...
export type CaptchaType = "recaptcha_v2" | "recaptcha_v3" | "hcaptcha" | "turnstile" | "none";
